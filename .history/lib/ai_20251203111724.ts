...
export async function generateStudyPlan(
  ...
  try {
    ...
    // Fallback: Try to recover if it's a simple JSON error or try Groq if Gemini fails completely
    // For now, we throw to let the API handler manage the error response
